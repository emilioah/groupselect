...
/**
 * Strings for component 'groupselect', language 'es', branch 'MOODLE_27_STABLE'
 *
 * @package   groupselect
...
$string['export'] = 'Descargar archivo CSV con listado de grupos';
$string['export2'] = 'Descargar archivo CSV con listado de alumnos';
